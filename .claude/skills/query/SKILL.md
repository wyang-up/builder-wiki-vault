---
name: query
description: Use when the user asks questions about the local wiki, their notes, prior decisions, past research, or knowledge stored in this vault, including explicit /query requests and natural-language questions about notebook content.
user-invocable: true
---
